...
export default function AdminNews() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div>
          ...
          <select style={{ width: '100%', padding: '10px', marginTop: '5px' }} onChange={e => setType(e.target.value)}>

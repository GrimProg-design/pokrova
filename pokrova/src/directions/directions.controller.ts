...
export class DirectionsController {
  ...
  async create(
    ...
    const data = {
      ...body,
      imagePath: files.cardImage
        ? `/uploads/sections/${files.cardImage[0].filename}`
        : null,
      innerImage1: files.inner1
        ? `/uploads/sections/${files.inner1[0].filename}`
        : null,
      innerImage2: files.inner2
        ? `/uploads/sections/${files.inner2[0].filename}`
        : null,
    };
